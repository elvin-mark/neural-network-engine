...
pub use data::{
    ...
    generate_xor_dataset, load_cifar100_dataset, load_cifar100_from_binary, load_cifar10_dataset,
    ...
    standardize, train_test_split, DataLoader, TensorDataset, CIFAR10_CLASSES,
};
